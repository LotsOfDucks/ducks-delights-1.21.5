...
public class ModFoodComponents {
    ...
    public static final FoodComponent WHITE_RICE = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.4F).build();
    ...
    public static final FoodComponent ROCK_CANDY = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.1F).build();
